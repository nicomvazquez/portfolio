...
function Portfolio() {
  return (
    <div className="bg-black w-full py-20" id="portfolio">
      <div className="w-4/5 lg:w-3/5 m-auto flex flex-col gap-20">
        <h1 className="text-6xl font-bold text-white">Portfolio</h1>
        <div className="w-full m-auto grid grid-cols-1 lg:grid-cols-3 gap-3 pb-10 justify-items-center text-white">{proyects.map((proyect) => (
